...
@app.route("/")
def index():
    # Render the page without any prediction data
...
def home():
    if request.method == 'POST':
        ...
        if not symptoms or symptoms.strip().lower() == "symptoms":
            message = "Please either write symptoms or correct any misspellings."
            return render_template('index.html',
                                   message=message,
                                   predicted_disease=None,
                                   dis_des=None,
    ...
    return render_template('index.html',predicted_disease=None,dis_des=None,my_precautions=[],medications=[],my_diet=[],workout=[])
